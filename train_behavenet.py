...
def train(args):
    ...
    train_set = BehavioralVideo(args.frames_per_clip, frame_rate=args.frame_rate, transform=transform, mod='train', rand_crop=True, jitter=True, return_first_frame=False)
